...
import { MOUSE, Vector3, PerspectiveCamera, OrthographicCamera, Quaternion, EventDispatcher, Vector2 } from 'three-full';
...
function OrbitControlsModified() {
    ...
    function OrbitConstraint ( object ) {
        ...
        this.getRadius = function () {
            ...
            return this.radius || offset.length() * scale;
        ...
        this.forceUpdate = function() {
            ...
            return function () {
                ...
                var radius = this.radius || offset.length() * scale;
    ...
    function OrbitControls ( object, domElement ) {
        ...
        this.setRadius = function (rad) {
            ...
            return constraint.setRadius(rad);

        };

        this.getRadius = function () {

            return constraint.getRadius();
...
OrbitControls = OrbitControlsModified();
