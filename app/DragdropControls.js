export default class DragdropControls {
    static setUpMouseHandler (element, mouseDownFunc, mouseDragFunc, mouseUpFunc) {
        /*
    ...
    static setUpTouchHandler (element, touchStartFunc, touchMoveFunc, touchEndFunc, touchCancelFunc) {
        /*
               element -- either the element itself or a string with the id of the element
